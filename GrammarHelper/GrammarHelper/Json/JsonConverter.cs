...
namespace GrammarHelper
{
    public static class JsonConverter
    {
        ...
        /// <returns></returns>
        public static dynamic JsonObject(object obj)
        {
            return ConvertJsonToObject(JosnSerialize(obj, true));
        }
        #region 自定义查询对象转换动态类、object动态类转换json包、json转换object动态类、DataReader转换为Json、DataSet转换为Json、DataTable转成Json、Datatable转换为Json 、格式化字符型日期型布尔型、过滤特殊字符等
        ...
        /// <returns></returns>
        public static string JosnSerialize(object obj, bool DateConvert = false)
        {
        ...
        public static string ConvertToJson(IDataReader dataReader)
        {
            try
            {
        ...
        public static string ConvertToJson(DataSet dataSet)
        {
            ...
            {
                jsonString += "\"" + table.TableName + "\":" + ConvertToJson(table) + ",";
            }
        ...
        /// <summary>
        /// 将dataSet转换成josn格式字符串用于grid
        /// </summary>
        /// <param name="ds">数据集</param>
        /// <param name="totalProperty">json 名称</param>
        ...
        //#region  将json 转换成适用tree 的json格式
